...
Item {
    ...
    // Signalled, when video Ended
    signal videoEnded

    onVideoEnded: videoEndedTimer.start();
    ...
    Loader {
        ...
        height: videoPlayView.isFullScreen ? screen.displayHeight : (videoPlayView.height
